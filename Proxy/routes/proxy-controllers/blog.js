...
exports.read = (req, res) => {
    ...
    Blog.findOne({ slug })
        ...
        .select('_id title cover_photo html body selectedProducts product_rating total_ratings autoGenerated slug mtitle mdesc tags postedBy trackingID createdAt updatedAt')
        .exec((err, data) => {
            if (err) {
                return res.json({
                    error: errorHandler(err)
