...
exports.testTemplate = ({shop}) => {
    return `
		...
		<div>
			Elisha's Dev Authorization Link: <a href='https://${shop+proxyRoute}/user/profile?email={{ customer.email }}&name={{ customer.name }}&hash={{ customer.email | append: "somecrazyhash" | md5 }}'>My Tribe Profile</a>
		</div>
		`
};